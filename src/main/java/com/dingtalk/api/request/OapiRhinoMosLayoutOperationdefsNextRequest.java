...
import com.dingtalk.api.response.OapiRhinoMosLayoutOperationdefsNextResponse;

/**
 * TOP DingTalk-API: dingtalk.oapi.rhino.mos.layout.operationdefs.next request
 * 
 * @author top auto create
 * @since 1.0, 2020.04.09
 */
public class OapiRhinoMosLayoutOperationdefsNextRequest extends BaseTaobaoRequest<OapiRhinoMosLayoutOperationdefsNextResponse> {
	...
	* 用户ID
	...
	public Class<OapiRhinoMosLayoutOperationdefsNextResponse> getResponseClass() {
		return OapiRhinoMosLayoutOperationdefsNextResponse.class;
	}
