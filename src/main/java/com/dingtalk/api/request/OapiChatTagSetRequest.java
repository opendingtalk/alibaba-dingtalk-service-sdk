...
import com.dingtalk.api.response.OapiChatTagSetResponse;

/**
 * TOP DingTalk-API: dingtalk.oapi.chat.tag.set request
 * 
 * @author top auto create
 * @since 1.0, 2019.10.31
 */
public class OapiChatTagSetRequest extends BaseTaobaoRequest<OapiChatTagSetResponse> {
	...
	* 群标签的类型。1表示经销群；2表示销管群
	...
	public Class<OapiChatTagSetResponse> getResponseClass() {
		return OapiChatTagSetResponse.class;
	}
