...
import com.dingtalk.api.response.OapiImChatbotAddResponse;

/**
 * TOP DingTalk-API: dingtalk.oapi.im.chatbot.add request
 * 
 * @author top auto create
 * @since 1.0, 2019.06.11
 */
public class OapiImChatbotAddRequest extends BaseTaobaoRequest<OapiImChatbotAddResponse> {
	...
	* 创建群时返回的openConvsationId
	...
	public String getApiMethodName() {
		return "dingtalk.oapi.im.chatbot.add";
	}
	...
	public Class<OapiImChatbotAddResponse> getResponseClass() {
		return OapiImChatbotAddResponse.class;
	}
