...
import com.dingtalk.api.response.OapiWorkspaceTasklistHiddenCancelResponse;
...
public class OapiWorkspaceTasklistHiddenCancelRequest extends BaseTaobaoRequest<OapiWorkspaceTasklistHiddenCancelResponse> {
	...
	* 用户id
	...
	public Class<OapiWorkspaceTasklistHiddenCancelResponse> getResponseClass() {
		return OapiWorkspaceTasklistHiddenCancelResponse.class;
	}
