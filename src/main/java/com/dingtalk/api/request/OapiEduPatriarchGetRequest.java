...
import com.dingtalk.api.response.OapiEduPatriarchGetResponse;

/**
 * TOP DingTalk-API: dingtalk.oapi.edu.patriarch.get request
 * 
 * @author top auto create
 * @since 1.0, 2018.11.24
 */
public class OapiEduPatriarchGetRequest extends BaseTaobaoRequest<OapiEduPatriarchGetResponse> {
	...
	* 家长ID
	...
	public String getApiMethodName() {
		return "dingtalk.oapi.edu.patriarch.get";
	}
	...
	public Class<OapiEduPatriarchGetResponse> getResponseClass() {
		return OapiEduPatriarchGetResponse.class;
	}
