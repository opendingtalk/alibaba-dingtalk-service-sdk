...
import com.dingtalk.api.response.OapiConferenceSyncallptcpResponse;

/**
 * TOP DingTalk-API: dingtalk.oapi.conference.syncallptcp request
 * 
 * @author top auto create
 * @since 1.0, 2018.11.20
 */
public class OapiConferenceSyncallptcpRequest extends BaseTaobaoRequest<OapiConferenceSyncallptcpResponse> {
	...
	* 操作用户id
	...
	public String getApiMethodName() {
		return "dingtalk.oapi.conference.syncallptcp";
	}
	...
	public Class<OapiConferenceSyncallptcpResponse> getResponseClass() {
		return OapiConferenceSyncallptcpResponse.class;
	}
