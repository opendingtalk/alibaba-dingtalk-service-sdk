...
import com.dingtalk.api.response.OapiConferenceSyncParticipantResponse;

/**
 * TOP DingTalk-API: dingtalk.oapi.conference.sync.participant request
 * 
 * @author top auto create
 * @since 1.0, 2018.11.20
 */
public class OapiConferenceSyncParticipantRequest extends BaseTaobaoRequest<OapiConferenceSyncParticipantResponse> {
	...
	* 操作用户id
	...
	public String getApiMethodName() {
		return "dingtalk.oapi.conference.sync.participant";
	}
	...
	public Class<OapiConferenceSyncParticipantResponse> getResponseClass() {
		return OapiConferenceSyncParticipantResponse.class;
	}
