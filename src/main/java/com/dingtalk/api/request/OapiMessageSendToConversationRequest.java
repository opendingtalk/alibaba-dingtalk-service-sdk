...
public class OapiMessageSendToConversationRequest extends BaseTaobaoRequest<OapiMessageSendToConversationResponse> {
	...
	* voice消息
	...
	public static class Head extends TaobaoObject {
		private static final long serialVersionUID = 6824112746769232551L;
		/**
	...
	public static class Oa extends TaobaoObject {
		private static final long serialVersionUID = 8716572113281176665L;
		/**
		 * 消息体
		 */
		@ApiField("body")
	...
	public static class Voice extends TaobaoObject {
		private static final long serialVersionUID = 7466489671815422516L;
		/**
		 * 语音时长
		 */
		@ApiField("duration")
	...
	public static class File extends TaobaoObject {
		private static final long serialVersionUID = 1262143677755336539L;
		/**
	...
	public static class Link extends TaobaoObject {
		private static final long serialVersionUID = 6478252382487822815L;
		/**
		 * 消息点击链接地址
		 */
		@ApiField("messageUrl")
	...
	public static class Image extends TaobaoObject {
		private static final long serialVersionUID = 5392993892926892268L;
		/**
	...
	public static class Text extends TaobaoObject {
		private static final long serialVersionUID = 2454897979865698218L;
		/**
		 * 消息内容
		 */
		@ApiField("content")
	...
	public static class BtnJson extends TaobaoObject {
		private static final long serialVersionUID = 4436295551474782589L;
		/**
	...
	public static class ActionCard extends TaobaoObject {
		private static final long serialVersionUID = 2315819519562522842L;
		/**
		 * 使用独立跳转ActionCard样式时的按钮列表；必须与btn_orientation同时设置
		 */
	...
	public static class Msg extends TaobaoObject {
		private static final long serialVersionUID = 1796855961949589899L;
		/**
		 * 消息内容，支持markdown，语法参考标准markdown语法。图片举例：![alt text](mediaId)
		 */
