...
import com.dingtalk.api.response.OapiRhinoMosExecPerformStartResponse;

/**
 * TOP DingTalk-API: dingtalk.oapi.rhino.mos.exec.perform.start request
 * 
 * @author top auto create
 * @since 1.0, 2020.07.03
 */
public class OapiRhinoMosExecPerformStartRequest extends BaseTaobaoRequest<OapiRhinoMosExecPerformStartResponse> {
	...
	* 执行员工列表
	...
	public Class<OapiRhinoMosExecPerformStartResponse> getResponseClass() {
		return OapiRhinoMosExecPerformStartResponse.class;
	}

	public void check() throws ApiRuleException {
		RequestCheckUtils.checkMaxListSize(deviceIds, 500, "deviceIds");
		...
		RequestCheckUtils.checkMaxListSize(workNos, 500, "workNos");
	}
