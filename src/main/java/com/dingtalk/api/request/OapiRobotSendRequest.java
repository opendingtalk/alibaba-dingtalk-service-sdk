...
public class OapiRobotSendRequest extends BaseTaobaoRequest<OapiRobotSendResponse> {
	...
	* text类型
	...
	public static class Text extends TaobaoObject {
		private static final long serialVersionUID = 3529752652421783419L;
		/**
		 * text类型
		 */
		@ApiField("content")
	...
	public static class At extends TaobaoObject {
		private static final long serialVersionUID = 4498645878981477286L;
		/**
		 * 被@人的手机号
		 */
	...
	public static class Link extends TaobaoObject {
		private static final long serialVersionUID = 3541211981892842955L;
		/**
		 * 点击消息跳转的URL
		 */
		@ApiField("messageUrl")
	...
	public static class Markdown extends TaobaoObject {
		private static final long serialVersionUID = 8236896161438881543L;
		/**
		 * markdown格式的消息
		 */
		@ApiField("text")
	...
	public static class Btns extends TaobaoObject {
		private static final long serialVersionUID = 8377958952216377157L;
		/**
		 * 按钮方案，
		 */
		@ApiField("actionURL")
	...
	public static class Actioncard extends TaobaoObject {
		private static final long serialVersionUID = 6892883886491619745L;
		/**
		 * 0-按钮竖直排列，1-按钮横向排列
		 */
	...
	public static class Links extends TaobaoObject {
		private static final long serialVersionUID = 3395373339275152983L;
		/**
		 * 点击单条信息到跳转链接
		 */
		@ApiField("messageURL")
	...
	public static class Feedcard extends TaobaoObject {
		private static final long serialVersionUID = 5657631875154435812L;
		/**
		 * links
		 */
		@ApiListField("links")
