...
/**
 * TOP DingTalk-API: dingtalk.oapi.call_back.update_call_back request
 * 
 * @author top auto create
 * @since 1.0, 2018.07.25
 */
public class OapiCallBackUpdateCallBackRequest extends BaseTaobaoRequest<OapiCallBackUpdateCallBackResponse> {
	...
	* 更新事件回调接口
	...
	public Class<OapiCallBackUpdateCallBackResponse> getResponseClass() {
		return OapiCallBackUpdateCallBackResponse.class;
	}
