...
import com.dingtalk.api.response.CorpHrmEmployeeUpdateresumerecordResponse;

/**
 * TOP DingTalk-API: dingtalk.corp.hrm.employee.updateresumerecord request
 * 
 * @author top auto create
 * @since 1.0, 2018.05.25
 */
public class CorpHrmEmployeeUpdateresumerecordRequest extends BaseTaobaoRequest<CorpHrmEmployeeUpdateresumerecordResponse> {
	...
	* webOA后台url
	...
	public String getApiMethodName() {
		return "dingtalk.corp.hrm.employee.updateresumerecord";
	}
	...
	public Class<CorpHrmEmployeeUpdateresumerecordResponse> getResponseClass() {
		return CorpHrmEmployeeUpdateresumerecordResponse.class;
	}
