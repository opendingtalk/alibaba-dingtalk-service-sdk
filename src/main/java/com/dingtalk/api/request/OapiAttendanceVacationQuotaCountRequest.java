...
import com.dingtalk.api.response.OapiAttendanceVacationQuotaCountResponse;

/**
 * TOP DingTalk-API: dingtalk.oapi.attendance.vacation.quota.count request
 * 
 * @author top auto create
 * @since 1.0, 2019.04.08
 */
public class OapiAttendanceVacationQuotaCountRequest extends BaseTaobaoRequest<OapiAttendanceVacationQuotaCountResponse> {
	...
	* test
	...
	public String getApiMethodName() {
		return "dingtalk.oapi.attendance.vacation.quota.count";
	}
	...
	public Class<OapiAttendanceVacationQuotaCountResponse> getResponseClass() {
		return OapiAttendanceVacationQuotaCountResponse.class;
	}
