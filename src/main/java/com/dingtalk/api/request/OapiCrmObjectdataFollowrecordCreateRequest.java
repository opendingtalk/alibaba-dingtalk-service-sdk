...
import com.dingtalk.api.response.OapiCrmObjectdataFollowrecordCreateResponse;

/**
 * TOP DingTalk-API: dingtalk.oapi.crm.objectdata.followrecord.create request
 * 
 * @author top auto create
 * @since 1.0, 2020.03.12
 */
public class OapiCrmObjectdataFollowrecordCreateRequest extends BaseTaobaoRequest<OapiCrmObjectdataFollowrecordCreateResponse> {
	...
	* 跟进记录数据
	...
	public String getApiMethodName() {
		return "dingtalk.oapi.crm.objectdata.followrecord.create";
	}
	...
	public Class<OapiCrmObjectdataFollowrecordCreateResponse> getResponseClass() {
		return OapiCrmObjectdataFollowrecordCreateResponse.class;
	}
	...
	public static class DataPermissionVo extends TaobaoObject {
		private static final long serialVersionUID = 3218335988472365423L;
		/**
		 * 负责人的用户ID
		 */
	...
	public static class ObjectDataInstanceVo extends TaobaoObject {
		private static final long serialVersionUID = 5756356584339712583L;
		/**
		 * 记录创建人的昵称
		 */
