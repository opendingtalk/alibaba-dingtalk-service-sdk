...
public class OapiCalendarV2EventCreateRequest extends BaseTaobaoRequest<OapiCalendarV2EventCreateResponse> {
	...
	* 日程创建对象
	...
	public static class Attendee extends TaobaoObject {
		private static final long serialVersionUID = 4229532594874387856L;
		/**
		 * 员工工号
		 */
		@ApiField("userid")
	...
	public static class DateTime extends TaobaoObject {
		private static final long serialVersionUID = 7153325777494621684L;
		/**
	...
	public static class OpenCalendarReminderVo extends TaobaoObject {
		private static final long serialVersionUID = 7834834823137695459L;
		/**
		 * 提醒方式.app表示应用内提醒
		 */
		@ApiField("method")
	...
	public static class LocationVo extends TaobaoObject {
		private static final long serialVersionUID = 1211124176997489324L;
		/**
		 * 纬度
		 */
		@ApiField("latitude")
	...
	public static class Event extends TaobaoObject {
		private static final long serialVersionUID = 5599596498976357688L;
		/**
		 * 日程参与者，参与者最大人数为100(包括组织者)
		 */
