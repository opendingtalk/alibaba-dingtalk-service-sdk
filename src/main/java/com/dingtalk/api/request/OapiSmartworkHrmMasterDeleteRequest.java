...
public class OapiSmartworkHrmMasterDeleteRequest extends BaseTaobaoRequest<OapiSmartworkHrmMasterDeleteResponse> {
	...
	* 业务方id(由系统统一分配)
	...
	public static class Fieldlist extends TaobaoObject {
		private static final long serialVersionUID = 5355271846998578448L;
		/**
		 * 字段名
		 */
		@ApiField("name")
	...
	public static class ScopeVo extends TaobaoObject {
		private static final long serialVersionUID = 1818223838561127718L;
		/**
		 * 业务域code
		 */
		@ApiField("scope_code")
	...
	public static class BizDataVo extends TaobaoObject {
		private static final long serialVersionUID = 8422393214299445944L;
		/**
		 * 数据业务时间戳
		 */
		@ApiField("biz_time")
