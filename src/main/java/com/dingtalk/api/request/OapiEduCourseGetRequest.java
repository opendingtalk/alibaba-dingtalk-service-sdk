...
/**
 * TOP DingTalk-API: dingtalk.oapi.edu.course.get request
 * 
 * @author top auto create
 * @since 1.0, 2020.08.10
 */
public class OapiEduCourseGetRequest extends BaseTaobaoRequest<OapiEduCourseGetResponse> {
	...
	* 当前操作人的用户ID
	...
	public Class<OapiEduCourseGetResponse> getResponseClass() {
		return OapiEduCourseGetResponse.class;
	}
