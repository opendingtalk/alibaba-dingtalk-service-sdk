...
public class OapiChatSendRequest extends BaseTaobaoRequest<OapiChatSendResponse> {
	...
	* 语音消息
	...
	public static class Oa extends TaobaoObject {
		private static final long serialVersionUID = 4443289495341642166L;
		/**
		 * 消息体
		 */
		@ApiField("body")
	...
	public static class Voice extends TaobaoObject {
		private static final long serialVersionUID = 1682671323654464777L;
		/**
		 * 语音正整数，小于60，表示音频时长长
		 */
		@ApiField("duration")
	...
	public static class File extends TaobaoObject {
		private static final long serialVersionUID = 7748816318167998621L;
		/**
		 * 文件mediaId
		 */
		@ApiField("media_id")
	...
	public static class Image extends TaobaoObject {
		private static final long serialVersionUID = 6759354664788654644L;
		/**
		 * 图片mediaId
		 */
		@ApiField("media_id")
	...
	public static class Link extends TaobaoObject {
		private static final long serialVersionUID = 3469853993277287929L;
		/**
		 * 消息点击链接地址
		 */
		@ApiField("messageUrl")
	...
	public static class Text extends TaobaoObject {
		private static final long serialVersionUID = 1864184621237575896L;
		/**
		 * 文本消息内容
		 */
		@ApiField("content")
	...
	public static class Markdown extends TaobaoObject {
		private static final long serialVersionUID = 7165414652696158131L;
		/**
		 * markdown格式的消息
		 */
		@ApiField("text")
	...
	public static class BtnJsonList extends TaobaoObject {
		private static final long serialVersionUID = 4468265973337444527L;
		/**
	...
	public static class Msg extends TaobaoObject {
		private static final long serialVersionUID = 5135644412562349829L;
		/**
		 * action_card卡片消息
		 */
