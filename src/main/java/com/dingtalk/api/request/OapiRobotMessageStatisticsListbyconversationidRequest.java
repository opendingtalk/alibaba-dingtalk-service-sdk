...
import com.dingtalk.api.response.OapiRobotMessageStatisticsListbyconversationidResponse;

/**
 * TOP DingTalk-API: dingtalk.oapi.robot.message.statistics.listbyconversationid request
 * 
 * @author top auto create
 * @since 1.0, 2019.07.01
 */
public class OapiRobotMessageStatisticsListbyconversationidRequest extends BaseTaobaoRequest<OapiRobotMessageStatisticsListbyconversationidResponse> {
	...
	* 已读状态
	...
	public Map<String, String> getTextParams() {		
		...
		txtParams.put("read_status", this.readStatus);
	...
	public Class<OapiRobotMessageStatisticsListbyconversationidResponse> getResponseClass() {
		return OapiRobotMessageStatisticsListbyconversationidResponse.class;
	}
