 ...
 */
public class OapiReportSimplelistRequest extends BaseTaobaoRequest<OapiReportSimplelistResponse> {
	...
	* 员工的userid
	...
	public Class<OapiReportSimplelistResponse> getResponseClass() {
