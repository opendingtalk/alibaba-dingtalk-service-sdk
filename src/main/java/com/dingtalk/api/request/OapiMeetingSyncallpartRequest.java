...
import com.dingtalk.api.response.OapiMeetingSyncallpartResponse;

/**
 * TOP DingTalk-API: dingtalk.oapi.meeting.syncallpart request
 * 
 * @author top auto create
 * @since 1.0, 2018.11.20
 */
public class OapiMeetingSyncallpartRequest extends BaseTaobaoRequest<OapiMeetingSyncallpartResponse> {
	...
	* 操作用户id
	...
	public String getApiMethodName() {
		return "dingtalk.oapi.meeting.syncallpart";
	}
	...
	public Class<OapiMeetingSyncallpartResponse> getResponseClass() {
		return OapiMeetingSyncallpartResponse.class;
	}
