...
import com.dingtalk.api.response.OapiRhinoMosLayoutOperationdefsSectionlastResponse;

/**
 * TOP DingTalk-API: dingtalk.oapi.rhino.mos.layout.operationdefs.sectionlast request
 * 
 * @author top auto create
 * @since 1.0, 2020.04.08
 */
public class OapiRhinoMosLayoutOperationdefsSectionlastRequest extends BaseTaobaoRequest<OapiRhinoMosLayoutOperationdefsSectionlastResponse> {
	...
	* 订单ID
	...
	public Class<OapiRhinoMosLayoutOperationdefsSectionlastResponse> getResponseClass() {
		return OapiRhinoMosLayoutOperationdefsSectionlastResponse.class;
	}
