...
import com.dingtalk.api.response.OapiCrmObjectdataFollowrecordUpdateResponse;

/**
 * TOP DingTalk-API: dingtalk.oapi.crm.objectdata.followrecord.update request
 * 
 * @author top auto create
 * @since 1.0, 2020.02.06
 */
public class OapiCrmObjectdataFollowrecordUpdateRequest extends BaseTaobaoRequest<OapiCrmObjectdataFollowrecordUpdateResponse> {
	...
	* 跟进记录数据
	...
	public String getApiMethodName() {
		return "dingtalk.oapi.crm.objectdata.followrecord.update";
	}
	...
	public Class<OapiCrmObjectdataFollowrecordUpdateResponse> getResponseClass() {
		return OapiCrmObjectdataFollowrecordUpdateResponse.class;
	}
	...
	public static class DataPermissionVo extends TaobaoObject {
		private static final long serialVersionUID = 7813796217128664728L;
		/**
		 * 负责人的用户ID
		 */
	...
	public static class ObjectDataInstanceVo extends TaobaoObject {
		private static final long serialVersionUID = 6842439317795156863L;
		/**
		 * 数据内容
		 */
		@ApiField("data")
