...
import com.dingtalk.api.response.OapiRhinoMosExecPerformCountResponse;

/**
 * TOP DingTalk-API: dingtalk.oapi.rhino.mos.exec.perform.count request
 * 
 * @author top auto create
 * @since 1.0, 2020.04.13
 */
public class OapiRhinoMosExecPerformCountRequest extends BaseTaobaoRequest<OapiRhinoMosExecPerformCountResponse> {
	...
	* 执行工位列表
	...
	public String getApiMethodName() {
		return "dingtalk.oapi.rhino.mos.exec.perform.count";
	}
	...
	public Class<OapiRhinoMosExecPerformCountResponse> getResponseClass() {
		return OapiRhinoMosExecPerformCountResponse.class;
	}
