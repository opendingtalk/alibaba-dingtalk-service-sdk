...
public class SmartworkAttendsGetusergroupResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5568613374315757866L;
	...
	public static class AtTimeVo extends TaobaoObject {
		private static final long serialVersionUID = 7118169635748253141L;
		/**
		 * 打卡时间跨几天
		 */
		@ApiField("across")
	...
	public static class AtSectionVo extends TaobaoObject {
		private static final long serialVersionUID = 6545584193374783565L;
		/**
		 * 班次中上下班详情列表
		 */
		@ApiListField("times")
	...
	public static class ClassSettingVo extends TaobaoObject {
		private static final long serialVersionUID = 3574614936154461141L;
		/**
		 * 休息开始时间
		 */
	...
	public static class AtClassVo extends TaobaoObject {
		private static final long serialVersionUID = 4751172759685863278L;
		/**
		 * 班次id
		 */
		@ApiField("class_id")
	...
	public static class AtGroupFullForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 6772964235737431634L;
		/**
		 * 考勤组中的班次列表
		 */
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 1428199211636577837L;
		/**
		 * dingOpenErrcode
		 */
