...
public class OapiProcessTemplateListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7385942179269642772L;
	...
	public static class Templatelist extends TaobaoObject {
		private static final long serialVersionUID = 7599159198528995241L;
		/**
		 * 是否可升级，加入收款账户组件
		 */
	...
	public static class CorpTemplateVo extends TaobaoObject {
		private static final long serialVersionUID = 4529637941584978865L;
		/**
		 * 下次调用时的offset入参
		 */
