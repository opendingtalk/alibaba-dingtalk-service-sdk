...
public class OapiWikiDocListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5424215626173145894L;
	...
	public static class OpenDocVO extends TaobaoObject {
		private static final long serialVersionUID = 5253251344737828177L;
		/**
		 * 知识库ID（加密后的）
		 */
		@ApiField("group_id")
	...
	public static class OpenPageResult extends TaobaoObject {
		private static final long serialVersionUID = 1276254126592686254L;
		/**
		 * 知识页列表
		 */
		@ApiListField("data")
