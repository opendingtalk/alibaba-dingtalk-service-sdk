...
public class OapiAttendanceGetusergroupResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8433694725226595594L;
	...
	public static class AtTimeVo extends TaobaoObject {
		private static final long serialVersionUID = 1783594628666384387L;
		/**
		 * 打卡时间跨几天
		 */
		@ApiField("across")
	...
	public static class AtSectionVo extends TaobaoObject {
		private static final long serialVersionUID = 8196777416288333288L;
		/**
		 * 班次中上下班详情列表
		 */
		@ApiListField("times")
	...
	public static class ClassSettingVo extends TaobaoObject {
		private static final long serialVersionUID = 2363882148556161175L;
		/**
		 * 休息开始时间
		 */
	...
	public static class AtClassVo extends TaobaoObject {
		private static final long serialVersionUID = 5815239556991674676L;
		/**
		 * 班次id
		 */
		@ApiField("class_id")
	...
	public static class AtGroupFullForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 1619316342555574246L;
		/**
		 * 考勤组中的班次列表
		 */
