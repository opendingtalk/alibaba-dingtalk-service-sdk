...
public class OapiKacDatavInactivatedUserListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8186329141552698682L;
	...
	public static class UnactivatedUserVo extends TaobaoObject {
		private static final long serialVersionUID = 4153432848559368931L;
		/**
		 * 部门id
		 */
		@ApiField("dept_id")
	...
	public static class UnactivatedUserResponse extends TaobaoObject {
		private static final long serialVersionUID = 7151458546497945995L;
		/**
		 * 人员列表
		 */
		@ApiListField("data")
