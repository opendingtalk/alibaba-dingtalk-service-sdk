...
public class OapiAttendanceGroupPositionsAddResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1786699412567683489L;
	...
	public static class Position extends TaobaoObject {
		private static final long serialVersionUID = 3791348893237711829L;
		/**
		 * 地址描述
		 */
		@ApiField("address")
	...
	public static class ErrorInfo extends TaobaoObject {
		private static final long serialVersionUID = 8586584659378961669L;
		/**
		 * 错误码
		 */
		@ApiField("code")
	...
	public static class Result extends TaobaoObject {
		private static final long serialVersionUID = 2327198851732532335L;
		/**
		 * 错误列表
		 */
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 1295471879322955873L;
		/**
		 * 错误码
		 */
		@ApiField("errcode")
