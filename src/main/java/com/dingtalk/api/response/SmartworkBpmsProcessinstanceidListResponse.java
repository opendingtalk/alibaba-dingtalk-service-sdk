...
public class SmartworkBpmsProcessinstanceidListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3552139413475184266L;
	...
	public static class ProcessInstanceTopVo extends TaobaoObject {
		private static final long serialVersionUID = 3312483484851811695L;
		/**
		 * 审批实例id
		 */
	...
	public static class PageResult extends TaobaoObject {
		private static final long serialVersionUID = 2399973746773655897L;
		/**
		 * list
		 */
		@ApiListField("list")
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 3267166887276963331L;
		/**
		 * 错误码
		 */
