...
public class OapiProcessWorkrecordTaskQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5357362321122421664L;
	...
	public static class FormItemVo extends TaobaoObject {
		private static final long serialVersionUID = 2767384927725891759L;
		/**
		 * 内容
		 */
		@ApiField("content")
	...
	public static class WorkRecordVo extends TaobaoObject {
		private static final long serialVersionUID = 1281617794928438185L;
		/**
		 * 表单列表
		 */
		@ApiListField("forms")
	...
	public static class PageResult extends TaobaoObject {
		private static final long serialVersionUID = 1745155131785463868L;
		/**
		 * 是否有更多数据
		 */
		@ApiField("has_more")
