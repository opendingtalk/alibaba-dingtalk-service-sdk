...
public class OapiSmartdevicePrintdetailGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3528967514597282749L;
	...
	public static class PrintDetailVO extends TaobaoObject {
		private static final long serialVersionUID = 8659886321676699129L;
		/**
		 * 部门扩展信息
		 */
	...
	public static class PageVO extends TaobaoObject {
		private static final long serialVersionUID = 7344768573939784216L;
		/**
		 * 是否有更多记录
		 */
		@ApiField("has_more")
