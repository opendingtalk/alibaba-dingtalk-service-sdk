...
/**
 * TOP DingTalk-API: dingtalk.oapi.rhino.mos.exec.perform.context.getall response.
 * 
 * @author top auto create
 * @since 1.0, null
 */
public class OapiRhinoMosExecPerformContextGetallResponse extends TaobaoResponse {

	private static final long serialVersionUID = 1684691994735413183L;
	...
	public static class OperationPerformDto extends TaobaoObject {
		private static final long serialVersionUID = 5232139113332153875L;
		/**
		 * 上下文
		 */
		@ApiField("context")
