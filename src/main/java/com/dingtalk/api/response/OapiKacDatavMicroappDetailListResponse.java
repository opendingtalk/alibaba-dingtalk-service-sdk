...
public class OapiKacDatavMicroappDetailListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3868741288192293622L;
	...
	public static class MicroAppSummaryVo extends TaobaoObject {
		private static final long serialVersionUID = 2192139334278954619L;
		/**
		 * 微应用名
		 */
	...
	public static class MicroAppSummaryResponse extends TaobaoObject {
		private static final long serialVersionUID = 1834236512189664817L;
		/**
		 * 数据列表
		 */
		@ApiListField("data")
