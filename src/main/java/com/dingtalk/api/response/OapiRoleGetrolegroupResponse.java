...
public class OapiRoleGetrolegroupResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6885987985158331243L;
	...
	public static class OpenRole extends TaobaoObject {
		private static final long serialVersionUID = 4441789385433543749L;
		/**
		 * 角色id
		 */
		@ApiField("role_id")
	...
	public static class OpenRoleGroup extends TaobaoObject {
		private static final long serialVersionUID = 6218874998782294725L;
		/**
		 * 角色组名
		 */
		@ApiField("group_name")
