...
/**
 * TOP DingTalk-API: dingtalk.oapi.rhino.mos.exec.productionorder.get response.
 * 
 * @author top auto create
 * @since 1.0, null
 */
public class OapiRhinoMosExecProductionorderGetResponse extends TaobaoResponse {

	private static final long serialVersionUID = 8376588829252586561L;
	 ...
	 */
	@ApiField("result")
	private ProductionOrderDto result;
	...
	public void setResult(ProductionOrderDto result) {
		this.result = result;
	}
	public ProductionOrderDto getResult( ) {
		return this.result;
	}
	...
	public static class ProductionOrderDto extends TaobaoObject {
		private static final long serialVersionUID = 2286857984476897523L;
		/**
		 * 外部订单ID
		 */
