...
public class OapiAttendanceVacationQuotaListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2872873492348794535L;
	...
	public static class Leavequotas extends TaobaoObject {
		private static final long serialVersionUID = 7851996739937475931L;
		/**
		 * 额度有效期结束时间(毫秒级时间戳)
		 */
		@ApiField("end_time")
	...
	public static class OapiLeaveQuotaUserListVo extends TaobaoObject {
		private static final long serialVersionUID = 4587843434336852719L;
		/**
		 * 是否存在更多记录
		 */
		@ApiField("has_more")
