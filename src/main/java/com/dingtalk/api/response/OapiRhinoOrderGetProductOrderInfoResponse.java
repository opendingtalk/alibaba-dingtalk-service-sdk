...
/**
 * TOP DingTalk-API: dingtalk.oapi.rhino.order.getProductOrderInfo response.
 * 
 * @author top auto create
 * @since 1.0, null
 */
public class OapiRhinoOrderGetProductOrderInfoResponse extends TaobaoResponse {

	private static final long serialVersionUID = 1677624478961673663L;
	...
	public static class SaleOrderVo extends TaobaoObject {
		private static final long serialVersionUID = 2875933834434611858L;
		/**
		 * 实际发货时间
		 */
	...
	public static class ProductOrderDto extends TaobaoObject {
		private static final long serialVersionUID = 1627798346446756984L;
		/**
		 * 实际完成时间
		 */
	...
	public static class HsfResult extends TaobaoObject {
		private static final long serialVersionUID = 7422211948515169868L;
		/**
		 * 响应码
		 */
		@ApiField("errcode")
