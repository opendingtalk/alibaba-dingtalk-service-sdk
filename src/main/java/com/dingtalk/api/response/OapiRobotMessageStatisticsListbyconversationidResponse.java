...
public class OapiRobotMessageStatisticsListbyconversationidResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8742612428574216196L;
	...
	public static class MsgStatByCIdResVo extends TaobaoObject {
		private static final long serialVersionUID = 5658353325422482783L;
		/**
		 * 群Id
		 */
	...
	public static class PaginationVo extends TaobaoObject {
		private static final long serialVersionUID = 2416453339648818299L;
		/**
		 * 当前页数
		 */
	...
	public static class RobotMsgStatPageResponse extends TaobaoObject {
		private static final long serialVersionUID = 6855231659565195985L;
		/**
		 * list
		 */
		@ApiListField("list")
