...
public class OapiInspectTaskListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6415656875966358355L;
	...
	public static class TopInspectTaskVo extends TaobaoObject {
		private static final long serialVersionUID = 8894331666432866215L;
		/**
		 * 签到时间戳，单位毫秒
		 */
	...
	public static class PageResult extends TaobaoObject {
		private static final long serialVersionUID = 5135726435142964742L;
		/**
		 * 是否还有数据
		 */
		@ApiField("has_more")
