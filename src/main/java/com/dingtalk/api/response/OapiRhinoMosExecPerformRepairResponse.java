...
/**
 * TOP DingTalk-API: dingtalk.oapi.rhino.mos.exec.perform.repair response.
 * 
 * @author top auto create
 * @since 1.0, null
 */
public class OapiRhinoMosExecPerformRepairResponse extends TaobaoResponse {

	private static final long serialVersionUID = 2621584764375841599L;
	...
	public static class OperationPerformDto extends TaobaoObject {
		private static final long serialVersionUID = 2371497888221853254L;
		/**
		 * 是否有效
		 */
		@ApiField("active")
