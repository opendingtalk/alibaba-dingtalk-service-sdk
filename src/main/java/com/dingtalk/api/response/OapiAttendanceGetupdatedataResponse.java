...
public class OapiAttendanceGetupdatedataResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3831368355647873568L;
	...
	public static class AtAttendanceResultForOpenVo extends TaobaoObject {
		private static final long serialVersionUID = 4373258664123374746L;
		/**
		 * 打卡类型 上班还是下班
		 */
		@ApiField("check_type")
	...
	public static class AtApproveForOpenVo extends TaobaoObject {
		private static final long serialVersionUID = 3655395954367949691L;
		/**
		 * 审批单开始时间
		 */
		@ApiField("begin_time")
	...
	public static class AtAttendanceRecordForOpenVo extends TaobaoObject {
		private static final long serialVersionUID = 6132974926251711889L;
		/**
		 * 基本定位精度
		 */
	...
	public static class AtRestTimeVo extends TaobaoObject {
		private static final long serialVersionUID = 8144933313162658138L;
		/**
		 * 休息开始时间
		 */
	...
	public static class AtClassSettingInfoForOpenVo extends TaobaoObject {
		private static final long serialVersionUID = 8588688846754729249L;
		/**
		 * restTimeVOList
		 */
	...
	public static class AtCheckInfoForOpenVo extends TaobaoObject {
		private static final long serialVersionUID = 6589485327716399224L;
		/**
		 * 审批单列表
		 */
