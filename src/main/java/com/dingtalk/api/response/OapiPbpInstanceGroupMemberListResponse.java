...
public class OapiPbpInstanceGroupMemberListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8546535794992582433L;
	...
	public static class PositionVo extends TaobaoObject {
		private static final long serialVersionUID = 4276267449363243924L;
		/**
		 * 成员id，根据类型不同表示不同
		 */
		@ApiField("member_id")
	...
	public static class PageResult extends TaobaoObject {
		private static final long serialVersionUID = 7279436222181157612L;
		/**
		 * 是否还有数据
		 */
		@ApiField("has_more")
