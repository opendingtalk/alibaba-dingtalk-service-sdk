...
public class OapiOrgListshortcutResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1243565854177722754L;
	...
	public static class OrgShortcutVO extends TaobaoObject {
		private static final long serialVersionUID = 8831977335397525647L;
		/**
		 * 类型，1表示工作台微应用
		 */
		@ApiField("type")
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 5127283951295923868L;
		/**
		 * dingOpenErrcode
		 */
		@ApiField("errcode")
