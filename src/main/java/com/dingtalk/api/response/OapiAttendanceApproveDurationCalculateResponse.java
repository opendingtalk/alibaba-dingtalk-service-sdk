...
public class OapiAttendanceApproveDurationCalculateResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5311661724196861915L;
	...
	public static class TopDayDurationVo extends TaobaoObject {
		private static final long serialVersionUID = 5372844349894764387L;
		/**
		 * 日期
		 */
		@ApiField("date")
	...
	public static class TopDurationVo extends TaobaoObject {
		private static final long serialVersionUID = 5842989425694962418L;
		/**
		 * 总时长
		 */
		@ApiField("duration")
