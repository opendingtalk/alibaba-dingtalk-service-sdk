...
public class OapiCollectionFormListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5698519366222689368L;
	...
	public static class FormSchemaSettingVo extends TaobaoObject {
		private static final long serialVersionUID = 7687381437565723959L;
		/**
		 * 表单类型
		 */
		@ApiField("biz_type")
	...
	public static class FormSchemaResponse extends TaobaoObject {
		private static final long serialVersionUID = 6793593979912766252L;
		/**
		 * 创建人
		 */
		@ApiField("creator")
	...
	public static class PageResult extends TaobaoObject {
		private static final long serialVersionUID = 1597794912329442243L;
		/**
		 * 是否有下一页
		 */
		@ApiField("has_more")
