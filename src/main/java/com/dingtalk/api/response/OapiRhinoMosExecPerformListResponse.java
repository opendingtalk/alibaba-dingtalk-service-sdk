...
/**
 * TOP DingTalk-API: dingtalk.oapi.rhino.mos.exec.perform.list response.
 * 
 * @author top auto create
 * @since 1.0, null
 */
public class OapiRhinoMosExecPerformListResponse extends TaobaoResponse {

	private static final long serialVersionUID = 1375548367353239162L;
	...
	public static class OperationPerformDto extends TaobaoObject {
		private static final long serialVersionUID = 8788537313993454894L;
		/**
		 * 是否有效
		 */
		@ApiField("active")
