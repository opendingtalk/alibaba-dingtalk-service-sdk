...
public class OapiCorpConversationMemberListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8391195238586657686L;
	...
	public static class OpenMemberModel extends TaobaoObject {
		private static final long serialVersionUID = 2411964999425964551L;
		/**
		 * 员工ID
		 */
		@ApiField("userid")
	...
	public static class OpenMemberListModel extends TaobaoObject {
		private static final long serialVersionUID = 3856324765177334516L;
		/**
		 * 成员信息
		 */
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 8788487193271399447L;
		/**
		 * 错误码
		 */
		@ApiField("errcode")
