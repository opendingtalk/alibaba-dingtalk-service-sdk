...
public class OapiRoleListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7346458411173281452L;
	...
	public static class OpenRole extends TaobaoObject {
		private static final long serialVersionUID = 6178876873634112136L;
		/**
		 * 角色id
		 */
		@ApiField("id")
	...
	public static class OpenRoleGroup extends TaobaoObject {
		private static final long serialVersionUID = 6633911626592615769L;
		/**
		 * 角色组id
		 */
		@ApiField("groupId")
	...
	public static class PageVo extends TaobaoObject {
		private static final long serialVersionUID = 1598754474634822218L;
		/**
		 * hasMore
		 */
		@ApiField("hasMore")
