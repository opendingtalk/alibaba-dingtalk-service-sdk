...
/**
 * TOP DingTalk-API: dingtalk.oapi.attendance.vacation.all.type.list response.
 * 
 * @author top auto create
 * @since 1.0, null
 */
public class OapiAttendanceVacationAllTypeListResponse extends TaobaoResponse {

	private static final long serialVersionUID = 4715732666483944147L;
	 ...
	 */
	@ApiListField("result")
	@ApiField("oapi_leave_type_response_vo")
	private List<OapiLeaveTypeResponseVo> result;
	...
	public void setResult(List<OapiLeaveTypeResponseVo> result) {
		this.result = result;
	}
	public List<OapiLeaveTypeResponseVo> getResult( ) {
		return this.result;
	}
	 ...
	 * @since 1.0, null
	 */
	public static class OapiLeaveTypeResponseVo extends TaobaoObject {
		private static final long serialVersionUID = 7811189953455375464L;
		/**
		...
		/**
		 * 假期来源（inner:OA后台新建;external:开放平台接口新建）
		 */
		@ApiField("source")
