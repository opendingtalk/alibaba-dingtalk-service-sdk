...
public class OapiCustomerserviceActionQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1743738848712288254L;
	...
	public static class TicketFieldDto extends TaobaoObject {
		private static final long serialVersionUID = 8563224976496627265L;
		/**
		 * 标签名
		 */
	...
	public static class TicketActionDto extends TaobaoObject {
		private static final long serialVersionUID = 3488754568737167986L;
		/**
		 * 动作表单字段列表
		 */
	...
	public static class PageQueryCursorResult extends TaobaoObject {
		private static final long serialVersionUID = 1756187697729333364L;
		/**
		 * 动作列表
		 */
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 6774392781275616937L;
		/**
		 * 错误码
		 */
		@ApiField("errcode")
