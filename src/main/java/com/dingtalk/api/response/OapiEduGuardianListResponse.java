...
public class OapiEduGuardianListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3183985648198874111L;
	...
	public static class GuardianRespone extends TaobaoObject {
		private static final long serialVersionUID = 6459664412946871963L;
		/**
		 * 家长ID
		 */
	...
	public static class PageResult extends TaobaoObject {
		private static final long serialVersionUID = 7261541268978231763L;
		/**
		 * 是否存在下一页
		 */
		@ApiField("has_more")
