...
public class OapiDdpaasObjectdataListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2618998277788931449L;
	...
	public static class DataPermissionVo extends TaobaoObject {
		private static final long serialVersionUID = 1812879438947241419L;
		/**
		 * 负责人用户ID列表
		 */
	...
	public static class ObjectDataInstanceVo extends TaobaoObject {
		private static final long serialVersionUID = 4281163949473291692L;
		/**
		 * 创建记录的用户昵称
		 */
