...
public class OapiKacDatavVideoliveDetailListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2342485472256726599L;
	...
	public static class VideoLiveDetailVo extends TaobaoObject {
		private static final long serialVersionUID = 1463946519299661443L;
		/**
		 * 直播群cid
		 */
		@ApiField("cid")
	...
	public static class VideoLiveDetailResponse extends TaobaoObject {
		private static final long serialVersionUID = 4312862218968419496L;
		/**
		 * 数据明细列表
		 */
		@ApiListField("data")
