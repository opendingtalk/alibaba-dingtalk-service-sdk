...
public class OapiAlitripBtripHotelOrderSearchResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8818317322484525394L;
	...
	public static class OpenCostCenterDo extends TaobaoObject {
		private static final long serialVersionUID = 7469952153377214176L;
		/**
		 * 企业id
		 */
		@ApiField("corpid")
	...
	public static class OpenInvoiceDo extends TaobaoObject {
		private static final long serialVersionUID = 6751854123541759939L;
		/**
		 * 商旅发票id
		 */
		@ApiField("id")
	...
	public static class OpenPriceInfo extends TaobaoObject {
		private static final long serialVersionUID = 3818357377652368933L;
		/**
		 * 交易类型
		 */
		@ApiField("category")
	...
	public static class OpenUserAffiliateDo extends TaobaoObject {
		private static final long serialVersionUID = 4239247546458622655L;
		/**
		 * 入住人名称
		 */
		@ApiField("user_name")
	...
	public static class OpenHotelOrderRs extends TaobaoObject {
		private static final long serialVersionUID = 2635646821144554325L;
		/**
		 * 商旅申请单id
		 */
		@ApiField("apply_id")
		 ...
		 */
		@ApiField("hotel_support_vat_invoice_type")
		private Long hotelSupportVatInvoiceType;
		/**
		 * 订单id
		 */
		@ApiField("id")
		...
		public Long getHotelSupportVatInvoiceType() {
			return this.hotelSupportVatInvoiceType;
		}
		public void setHotelSupportVatInvoiceType(Long hotelSupportVatInvoiceType) {
	...
	public static class PageInfoRs extends TaobaoObject {
		private static final long serialVersionUID = 3765363673145267638L;
		/**
		 * 当前页
		 */
		@ApiField("page")
