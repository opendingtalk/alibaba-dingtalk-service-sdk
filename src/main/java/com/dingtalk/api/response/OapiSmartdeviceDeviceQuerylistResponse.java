...
public class OapiSmartdeviceDeviceQuerylistResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4345861735487726361L;
	...
	public static class DeviceDetailVO extends TaobaoObject {
		private static final long serialVersionUID = 2522223649164451769L;
		/**
		 * 企业id
		 */
		@ApiField("corp_id")
	...
	public static class PageResult extends TaobaoObject {
		private static final long serialVersionUID = 1378295262749334411L;
		/**
		 * 是否有下一页
		 */
		@ApiField("has_more")
