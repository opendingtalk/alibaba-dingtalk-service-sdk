...
public class OapiWorkspaceCorpMemberAddResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6864381568891892276L;
	...
	public static class OpenTagDto extends TaobaoObject {
		private static final long serialVersionUID = 3533257712923138629L;
		/**
		 * 角色的code
		 */
		@ApiField("code")
	...
	public static class OpenMemberDto extends TaobaoObject {
		private static final long serialVersionUID = 7471591276997264255L;
		/**
		 * 组织id
		 */
		@ApiField("corp_id")
