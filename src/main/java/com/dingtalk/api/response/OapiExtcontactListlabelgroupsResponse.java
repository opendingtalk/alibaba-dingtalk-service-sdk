...
public class OapiExtcontactListlabelgroupsResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1879638186562116384L;
	...
	public static class OpenLabel extends TaobaoObject {
		private static final long serialVersionUID = 8279113148923866672L;
		/**
		 * 标签id
		 */
		@ApiField("id")
	...
	public static class OpenLabelGroup extends TaobaoObject {
		private static final long serialVersionUID = 3192382497646423345L;
		/**
		 * 标签组颜色
		 */
		@ApiField("color")
