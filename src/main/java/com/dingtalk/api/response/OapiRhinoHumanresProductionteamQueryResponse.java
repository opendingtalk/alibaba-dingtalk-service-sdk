...
public class OapiRhinoHumanresProductionteamQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4623559356793966143L;
	...
	public static class EmpList extends TaobaoObject {
		private static final long serialVersionUID = 7232712496168391214L;
		/**
		 * 部门邮箱
		 */
		@ApiField("bu_mail")
	...
	public static class WeekdayConfigList extends TaobaoObject {
		private static final long serialVersionUID = 7166699173171867831L;
		/**
		 * 星期
		 */
		@ApiField("day")
	...
	public static class Model extends TaobaoObject {
		private static final long serialVersionUID = 8277233412126178359L;
		/**
		 * 业务ID
		 */
		@ApiField("biz_id")
