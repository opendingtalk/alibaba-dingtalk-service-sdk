...
public class OapiCateringMealconfigGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5561172927465638565L;
	...
	public static class Mealitemlist extends TaobaoObject {
		private static final long serialVersionUID = 7492412136457656373L;
		/**
		 * 送达时间 HH:mm
		 */
	...
	public static class Addressvos extends TaobaoObject {
		private static final long serialVersionUID = 8384252445475223114L;
		/**
		 * 缩略地址，可为空
		 */
		@ApiField("address")
	...
	public static class GroupMealSettingVo extends TaobaoObject {
		private static final long serialVersionUID = 7441217324251688924L;
		/**
		 * 缩略地址，可为空
		 */
		@ApiField("address")
