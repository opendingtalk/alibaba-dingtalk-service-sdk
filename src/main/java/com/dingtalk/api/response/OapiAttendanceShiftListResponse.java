...
public class OapiAttendanceShiftListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4431118988813296162L;
	...
	public static class TopMinimalismShiftVo extends TaobaoObject {
		private static final long serialVersionUID = 3513532754834265747L;
		/**
		 * 班次id
		 */
		@ApiField("id")
	...
	public static class PageResult extends TaobaoObject {
		private static final long serialVersionUID = 7485267916398514114L;
		/**
		 * 下一次访问游标
		 */
		@ApiField("cursor")
