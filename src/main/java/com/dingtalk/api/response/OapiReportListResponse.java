...
public class OapiReportListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5415244925927488988L;
	...
	public static class JsonObject extends TaobaoObject {
		private static final long serialVersionUID = 8368159438866222897L;
		/**
		 * 模板内容
		 */
		@ApiField("key")
	...
	public static class ReportOapiVo extends TaobaoObject {
		private static final long serialVersionUID = 8549362496465981413L;
		/**
		 * 日志内容
		 */
	...
	public static class PageVo extends TaobaoObject {
		private static final long serialVersionUID = 6441115436175196312L;
		/**
		 * 日志列表
		 */
