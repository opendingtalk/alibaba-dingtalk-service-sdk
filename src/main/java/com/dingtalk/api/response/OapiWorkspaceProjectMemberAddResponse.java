...
public class OapiWorkspaceProjectMemberAddResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2632415282947257875L;
	...
	public static class OpenTagDto extends TaobaoObject {
		private static final long serialVersionUID = 7261189543719469324L;
		/**
		 * 角色的code
		 */
		@ApiField("code")
	...
	public static class OpenProjectMemberDto extends TaobaoObject {
		private static final long serialVersionUID = 4558573167246344189L;
		/**
		 * 组织id
		 */
		@ApiField("corp_id")
