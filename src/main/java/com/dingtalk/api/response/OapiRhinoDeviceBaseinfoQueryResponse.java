...
/**
 * TOP DingTalk-API: dingtalk.oapi.rhino.device.baseinfo.query response.
 * 
 * @author top auto create
 * @since 1.0, null
 */
public class OapiRhinoDeviceBaseinfoQueryResponse extends TaobaoResponse {

	private static final long serialVersionUID = 3186214628971336858L;
	...
	public static class DeviceInstanceBriefResp extends TaobaoObject {
		private static final long serialVersionUID = 4722848235997163274L;
		/**
		 * 占地面积
		 */
		@ApiField("area")
