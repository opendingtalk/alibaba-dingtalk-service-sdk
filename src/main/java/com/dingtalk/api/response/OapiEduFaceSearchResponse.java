...
public class OapiEduFaceSearchResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3777769287713928175L;
	...
	public static class Faces extends TaobaoObject {
		private static final long serialVersionUID = 8713749245338554568L;
		/**
		 * 来自录入还是标记
		 */
		@ApiField("face_type")
	...
	public static class TopSubmitFaceSearchResponse extends TaobaoObject {
		private static final long serialVersionUID = 8622673473497395241L;
		/**
		 * 人脸列表
		 */
		@ApiListField("faces")
