...
public class OapiWorkspaceProjectQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3477565142982241946L;
	...
	public static class OpenTagDto extends TaobaoObject {
		private static final long serialVersionUID = 8574998854327569228L;
		/**
		 * 角色的code
		 */
		@ApiField("code")
	...
	public static class OpenProjectMemberDto extends TaobaoObject {
		private static final long serialVersionUID = 1792853554599714637L;
		/**
		 * 组织id
		 */
		@ApiField("corp_id")
	...
	public static class OpenProjectDto extends TaobaoObject {
		private static final long serialVersionUID = 8353341566855522845L;
		/**
		 * 组织id
		 */
		@ApiField("corp_id")
