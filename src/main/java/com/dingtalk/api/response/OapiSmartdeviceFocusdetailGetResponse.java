...
public class OapiSmartdeviceFocusdetailGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5873625345782144165L;
	...
	public static class FocusDetailVO extends TaobaoObject {
		private static final long serialVersionUID = 7718786947642926311L;
		/**
		 * 投屏时间，单位毫秒
		 */
	...
	public static class PageVO extends TaobaoObject {
		private static final long serialVersionUID = 6473715225131835132L;
		/**
		 * 是否有更多记录
		 */
		@ApiField("has_more")
