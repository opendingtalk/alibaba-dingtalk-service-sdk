...
public class OapiRhinoMosLayoutOperationdefGetflowResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8533479575948912763L;
	...
	public static class OperationExecutorAssignDto extends TaobaoObject {
		private static final long serialVersionUID = 1267113484386527893L;
		/**
		 * 工序执行器ID
		 */
	...
	public static class DeviceAssignDto extends TaobaoObject {
		private static final long serialVersionUID = 8368967355845852653L;
		/**
		 * 设备ID
		 */
		@ApiField("device_id")
	...
	public static class WorkerAssignDto extends TaobaoObject {
		private static final long serialVersionUID = 4271178679879125538L;
		/**
		 * 姓名
		 */
		@ApiField("name")
	...
	public static class WorkstationAssignDto extends TaobaoObject {
		private static final long serialVersionUID = 7717986622843595957L;
		/**
		 * 站位编码
		 */
	...
	public static class WorkUnitDto extends TaobaoObject {
		private static final long serialVersionUID = 2147885486725269845L;
		/**
		 * 设备分配列表
		 */
	...
	public static class OperationDefDto extends TaobaoObject {
		private static final long serialVersionUID = 7391976333835358116L;
		/**
		 * 适用尺码
		 */
	...
	public static class OperationDefFlowDto extends TaobaoObject {
		private static final long serialVersionUID = 8868964197853423772L;
		/**
		 * 是否激活最大版本
		 */
		@ApiField("active")
