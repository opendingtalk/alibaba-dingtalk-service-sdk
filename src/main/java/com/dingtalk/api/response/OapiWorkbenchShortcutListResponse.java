...
public class OapiWorkbenchShortcutListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6263316179744799214L;
	...
	public static class IsvOrgShortcutDTO extends TaobaoObject {
		private static final long serialVersionUID = 4866463566182271795L;
		/**
		 * 业务单号,系统间交互唯一流水号
		 */
		@ApiField("biz_no")
	...
	public static class IsvOrgShortcutListDTO extends TaobaoObject {
		private static final long serialVersionUID = 7591775841857646678L;
		/**
		 * 企业下指定应用已添加快捷方式列表
		 */
