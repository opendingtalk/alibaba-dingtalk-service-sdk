...
public class OapiWorkspaceTaskCreateResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4263539331274493452L;
	...
	public static class TaskSystemProperty extends TaobaoObject {
		private static final long serialVersionUID = 7572328588775175321L;
		/**
		 * APP 跳转连接
		 */
		@ApiField("appUrl")
	...
	public static class TaskExtension extends TaobaoObject {
		private static final long serialVersionUID = 5217737678344785211L;
		/**
		 * 评论数量
		 */
	...
	public static class Task extends TaobaoObject {
		private static final long serialVersionUID = 5575185566277354653L;
		/**
		 * 归属企业id
		 */
