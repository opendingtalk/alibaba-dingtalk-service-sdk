...
public class OapiCrmObjectmetaCustomerDescribeResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3295517865553328757L;
	...
	public static class SelectOptions extends TaobaoObject {
		private static final long serialVersionUID = 8268181655535882786L;
		/**
		 * 选项key
		 */
		@ApiField("key")
	...
	public static class ReferenceFields extends TaobaoObject {
		private static final long serialVersionUID = 2318465485366431187L;
		/**
		 * 引用的关联对象字段格式
		 */
		@ApiField("format")
	...
	public static class RollUpSummaryFields extends TaobaoObject {
		private static final long serialVersionUID = 7513691252712416982L;
		/**
		 * 汇总方法
		 */
		@ApiField("aggregator")
	...
	public static class Fields extends TaobaoObject {
		private static final long serialVersionUID = 6492424114176796945L;
		/**
		 * 是否自定义字段
		 */
		@ApiField("customized")
	...
	public static class DObject extends TaobaoObject {
		private static final long serialVersionUID = 5816145273811244825L;
		/**
		 * 表单code
		 */
		@ApiField("code")
