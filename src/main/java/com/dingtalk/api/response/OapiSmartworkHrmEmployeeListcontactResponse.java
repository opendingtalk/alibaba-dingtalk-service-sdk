...
public class OapiSmartworkHrmEmployeeListcontactResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1674584756196187245L;
	...
	public static class EmpFieldVo extends TaobaoObject {
		private static final long serialVersionUID = 5147277319967683666L;
		/**
		 * 字段编码
		 */
		@ApiField("field_code")
	...
	public static class EmpFieldInfoVo extends TaobaoObject {
		private static final long serialVersionUID = 2778826833265786387L;
		/**
		 * 字段信息列表
		 */
