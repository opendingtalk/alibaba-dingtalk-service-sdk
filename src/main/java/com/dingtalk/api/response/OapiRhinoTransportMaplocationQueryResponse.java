...
public class OapiRhinoTransportMaplocationQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6338727815896353197L;
	...
	public static class Configs extends TaobaoObject {
		private static final long serialVersionUID = 7458629453894869375L;
		/**
		 * 位置id
		 */
	...
	public static class MapLocationDetailResult extends TaobaoObject {
		private static final long serialVersionUID = 8157486191273991248L;
		/**
		 * config信息
		 */
