...
public class OapiCalendarV2EventDetailResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3334962864949277431L;
	...
	public static class Attendee extends TaobaoObject {
		private static final long serialVersionUID = 4255866747656839375L;
		/**
		 * 员工工号
		 */
		@ApiField("userid")
	...
	public static class DateTime extends TaobaoObject {
		private static final long serialVersionUID = 5484546422993878554L;
		/**
	...
	public static class OpenCalendarReminderVo extends TaobaoObject {
		private static final long serialVersionUID = 1426722295155927773L;
		/**
		 * 提醒方式.app表示应用内提醒
		 */
		@ApiField("method")
	...
	public static class LocationVo extends TaobaoObject {
		private static final long serialVersionUID = 4775448516335394175L;
		/**
		 * 经度
		 */
		@ApiField("latitude")
	...
	public static class Event extends TaobaoObject {
		private static final long serialVersionUID = 8837964336757654623L;
		/**
		 * 日程参与者
		 */
