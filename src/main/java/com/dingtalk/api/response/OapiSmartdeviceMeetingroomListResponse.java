...
public class OapiSmartdeviceMeetingroomListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2174514623265753819L;
	...
	public static class MeetingRoomOpenInfo extends TaobaoObject {
		private static final long serialVersionUID = 1761854964333874937L;
		/**
		 * 会议室容量
		 */
		@ApiField("capacity")
	...
	public static class OpenPageResult extends TaobaoObject {
		private static final long serialVersionUID = 8748949844922676265L;
		/**
		 * 是否有下一页
		 */
		@ApiField("has_more")
