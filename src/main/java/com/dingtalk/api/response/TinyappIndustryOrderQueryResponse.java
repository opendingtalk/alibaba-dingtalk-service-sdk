...
/**
 * TOP DingTalk-API: dingtalk.tinyapp.industry.order.query response.
 * 
 * @author top auto create
 * @since 1.0, null
 */
public class TinyappIndustryOrderQueryResponse extends TaobaoResponse {

	private static final long serialVersionUID = 4853123798912442714L;
	...
	public static class IndustryOrderQueryOpenResponse extends TaobaoObject {
		private static final long serialVersionUID = 7179114396564851287L;
		/**
		 * 业务金额(分)
		 */
		@ApiField("biz_amount")
