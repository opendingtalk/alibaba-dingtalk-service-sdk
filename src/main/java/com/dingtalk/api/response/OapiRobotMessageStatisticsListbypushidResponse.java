...
public class OapiRobotMessageStatisticsListbypushidResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1244234967215142918L;
	...
	public static class PaginationVo extends TaobaoObject {
		private static final long serialVersionUID = 6573751359723199238L;
		/**
		 * 当前页数
		 */
	...
	public static class MsgStatByPushIdResVo extends TaobaoObject {
		private static final long serialVersionUID = 3262587235854441395L;
		/**
		 * 群Id
		 */
	...
	public static class RobotMsgStatPageResponse extends TaobaoObject {
		private static final long serialVersionUID = 5788699852253887736L;
		/**
		 * list
		 */
		@ApiListField("list")
