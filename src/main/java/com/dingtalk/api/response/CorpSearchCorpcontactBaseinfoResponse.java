...
public class CorpSearchCorpcontactBaseinfoResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4816977836743975953L;
	...
	public static class GroupContactResult extends TaobaoObject {
		private static final long serialVersionUID = 7861384684248591539L;
		/**
		 * aliTmpDept
		 */
	...
	public static class PageResult extends TaobaoObject {
		private static final long serialVersionUID = 1571414213825644776L;
		/**
		 * 是否还有更多数据
		 */
		@ApiField("has_more")
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 6469498286829517619L;
		/**
		 * dingOpenErrcode
		 */
