...
public class SmartworkAttendsGetleaveapprovedurationResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4889541444341853513L;
	...
	public static class ApproveDurationForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 3662581912821497464L;
		/**
		 * 请假时长（单位分钟）
		 */
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 5441934236651794393L;
		/**
		 * dingOpenErrcode
		 */
