...
public class OapiAppstoreInternalUnfinishedorderListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2482673395151476789L;
	...
	public static class InAppGoodsOrderVO extends TaobaoObject {
		private static final long serialVersionUID = 4425815482798677958L;
		/**
		 * 订单号
		 */
	...
	public static class PageModel extends TaobaoObject {
		private static final long serialVersionUID = 2126825516748217616L;
		/**
		 * 订单信息列表
		 */
		@ApiListField("items")
