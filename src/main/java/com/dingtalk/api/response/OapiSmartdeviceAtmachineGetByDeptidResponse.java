...
public class OapiSmartdeviceAtmachineGetByDeptidResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3629784679892797351L;
	...
	public static class MachineVo extends TaobaoObject {
		private static final long serialVersionUID = 2567823116223181297L;
		/**
		 * 考勤机名称
		 */
	...
	public static class MachineInfoResultVo extends TaobaoObject {
		private static final long serialVersionUID = 4738566914463315875L;
		/**
		 * 分页查询中，后页是否还有数据
		 */
		@ApiField("has_more")
