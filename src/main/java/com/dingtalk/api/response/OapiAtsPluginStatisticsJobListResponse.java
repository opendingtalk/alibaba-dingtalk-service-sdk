...
public class OapiAtsPluginStatisticsJobListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7742317753366985126L;
	...
	public static class TopJobStatisticsVo extends TaobaoObject {
		private static final long serialVersionUID = 2542223867772244888L;
		/**
		 * 招聘业务标识
		 */
		@ApiField("biz_code")
	...
	public static class AtsPageResult extends TaobaoObject {
		private static final long serialVersionUID = 4545558423493725872L;
		/**
		 * 是否还有数据
		 */
		@ApiField("has_more")
