...
/**
 * TOP DingTalk-API: dingtalk.microapp.industry.order.create response.
 * 
 * @author top auto create
 * @since 1.0, null
 */
public class MicroappIndustryOrderCreateResponse extends TaobaoResponse {

	private static final long serialVersionUID = 6793523692856814873L;
	...
	public static class IndustryOrderCreateOpenResponse extends TaobaoObject {
		private static final long serialVersionUID = 7686354263416143332L;
		/**
		 * 业务错误码
		 */
