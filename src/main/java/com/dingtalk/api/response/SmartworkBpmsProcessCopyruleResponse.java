...
/**
 * TOP DingTalk-API: dingtalk.smartwork.bpms.process.copyrule response.
 * 
 * @author top auto create
 * @since 1.0, null
 */
public class SmartworkBpmsProcessCopyruleResponse extends TaobaoResponse {

	private static final long serialVersionUID = 4667959842523832925L;
	...
	public static class ProcessTopVo extends TaobaoObject {
		private static final long serialVersionUID = 6231256782645664911L;
		/**
		 * 业务分类标识
		 */
