...
public class OapiCalendarListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6894277511674336641L;
	...
	public static class Attendees extends TaobaoObject {
		private static final long serialVersionUID = 8389757914331269758L;
		/**
		 * 展示姓名
		 */
	...
	public static class User extends TaobaoObject {
		private static final long serialVersionUID = 4593153951787172517L;
		/**
		 * 展示姓名
		 */
		@ApiField("display_name")
	...
	public static class DateTime extends TaobaoObject {
		private static final long serialVersionUID = 1777444458696959829L;
		/**
	...
	public static class Items extends TaobaoObject {
		private static final long serialVersionUID = 8777332147361988279L;
		/**
		 * 参与者,考虑性能问题，该字段不向外透出
		 */
	...
	public static class OpenCalendarListResponse extends TaobaoObject {
		private static final long serialVersionUID = 6368339218585235297L;
		/**
		 * 日程的实体
		 */
		@ApiListField("items")
