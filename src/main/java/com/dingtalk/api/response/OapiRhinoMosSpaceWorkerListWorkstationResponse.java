...
/**
 * TOP DingTalk-API: dingtalk.oapi.rhino.mos.space.worker.list.workstation response.
 * 
 * @author top auto create
 * @since 1.0, null
 */
public class OapiRhinoMosSpaceWorkerListWorkstationResponse extends TaobaoResponse {

	private static final long serialVersionUID = 5694491647372828817L;
	...
	public static class ProdWorkstationWorkerCheckDto extends TaobaoObject {
		private static final long serialVersionUID = 5411362263759843494L;
		/**
		 * 登入时间
		 */
