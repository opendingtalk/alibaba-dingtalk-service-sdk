...
public class OapiRetailUserBindqueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7659169434371686477L;
	...
	public static class ApplyUserDto extends TaobaoObject {
		private static final long serialVersionUID = 6653526258839687774L;
		/**
		 * 业务渠道
		 */
		@ApiField("channel")
	...
	public static class UserBindDto extends TaobaoObject {
		private static final long serialVersionUID = 4323746188173365141L;
		/**
		 * 中心组织唯一ID
		 */
