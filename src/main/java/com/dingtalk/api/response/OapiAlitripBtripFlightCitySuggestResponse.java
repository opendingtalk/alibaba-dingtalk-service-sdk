...
public class OapiAlitripBtripFlightCitySuggestResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6222744879825348423L;
	...
	public static class CityVo extends TaobaoObject {
		private static final long serialVersionUID = 8493244846888935134L;
		/**
		 * 三字码
		 */
		@ApiField("code")
	...
	public static class SuggestRs extends TaobaoObject {
		private static final long serialVersionUID = 5379588574217754783L;
		/**
		 * 城市列表
		 */
		@ApiListField("cities")
