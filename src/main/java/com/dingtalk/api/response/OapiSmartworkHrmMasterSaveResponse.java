...
public class OapiSmartworkHrmMasterSaveResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3176584773889885836L;
	...
	public static class Failresult extends TaobaoObject {
		private static final long serialVersionUID = 6795721434632431268L;
		/**
		 * 业务流水唯一标识，和入参一致
		 */
		@ApiField("biz_uk")
	...
	public static class IntegrateBatchResultVO extends TaobaoObject {
		private static final long serialVersionUID = 3442113796974197398L;
		/**
		 * 是否全部保存成功
		 */
