...
public class OapiAttendanceGetsimplegroupsResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3221555118764656652L;
	...
	public static class AtTimeVo extends TaobaoObject {
		private static final long serialVersionUID = 2641782217368864642L;
		/**
		 * 开始时间
		 */
		@ApiField("check_time")
	...
	public static class ClassSettingVo extends TaobaoObject {
		private static final long serialVersionUID = 5392891685326464815L;
		/**
		 * 旷工迟到时长,单位分钟
		 */
	...
	public static class SetionTimeVO extends TaobaoObject {
		private static final long serialVersionUID = 3579891179349894462L;
		/**
		 * 打卡时间跨度
		 */
		@ApiField("across")
	...
	public static class AtSectionVo extends TaobaoObject {
		private static final long serialVersionUID = 2625923544225394637L;
		/**
		 * 时间段列表
		 */
		@ApiListField("times")
	...
	public static class AtClassVo extends TaobaoObject {
		private static final long serialVersionUID = 2183873927265199587L;
		/**
		 * 考勤班次id
		 */
		@ApiField("class_id")
	...
	public static class AtGroupForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 4843771665591784251L;
		/**
	...
	public static class AtGroupListForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 5346138519399158292L;
		/**
		 * 考勤组列表
		 */
		@ApiListField("groups")
