...
public class OapiSmartworkHrmEmployeeFieldGrouplistResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3626973652992318277L;
	...
	public static class FieldMetaInfo extends TaobaoObject {
		private static final long serialVersionUID = 3323722855139494327L;
		/**
		 * 字段code
		 */
		@ApiField("field_code")
	...
	public static class GroupMetaInfo extends TaobaoObject {
		private static final long serialVersionUID = 3296522329163827221L;
		/**
		 * 组里面的字段集合
		 */
