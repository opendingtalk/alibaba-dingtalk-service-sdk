...
public class OapiKacDatavDeptVideoliveListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1344468793725459381L;
	...
	public static class VideoLiveDeptSummaryVo extends TaobaoObject {
		private static final long serialVersionUID = 3217843899521881128L;
		/**
		 * 部门id
		 */
		@ApiField("dept_id")
	...
	public static class VideoLiveDeptSummaryResponse extends TaobaoObject {
		private static final long serialVersionUID = 8115788236559419483L;
		/**
		 * data
		 */
		@ApiListField("data")
