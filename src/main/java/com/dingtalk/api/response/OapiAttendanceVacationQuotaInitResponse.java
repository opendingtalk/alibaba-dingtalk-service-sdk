...
public class OapiAttendanceVacationQuotaInitResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8242627311874487718L;
	...
	public static class Quota extends TaobaoObject {
		private static final long serialVersionUID = 2687818347976974756L;
		/**
		 * 假期类型唯一标识
		 */
		@ApiField("leave_code")
	...
	public static class Result extends TaobaoObject {
		private static final long serialVersionUID = 1454171749991286433L;
		/**
		 * 失败记录
		 */
		@ApiField("quota")
