...
/**
 * TOP DingTalk-API: dingtalk.oapi.edu.patriarch.list response.
 * 
 * @author top auto create
 * @since 1.0, null
 */
public class OapiEduPatriarchListResponse extends TaobaoResponse {

	private static final long serialVersionUID = 3165134945774327181L;
	...
	public static class PatriarchRespone extends TaobaoObject {
		private static final long serialVersionUID = 1832586662622645718L;
		/**
		 * 家长ID
		 */
	...
	public static class PageResult extends TaobaoObject {
		private static final long serialVersionUID = 1127974476929414788L;
		/**
		 * 是否存在下一页
		 */
		@ApiField("has_more")
		 ...
		 */
		@ApiListField("list")
		@ApiField("patriarch_respone")
		private List<PatriarchRespone> list;
		/**
		 * 分页游标
		 */
		...
		public List<PatriarchRespone> getList() {
			return this.list;
		}
		public void setList(List<PatriarchRespone> list) {
			this.list = list;
		}
