...
public class OapiHireStatisticsBizflowListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3624257891915559539L;
	...
	public static class TopBizFlowStatisticsVo extends TaobaoObject {
		private static final long serialVersionUID = 2173598531952336377L;
		/**
		 * 候选人id
		 */
	...
	public static class DdAtsPageResult extends TaobaoObject {
		private static final long serialVersionUID = 6571117834448253794L;
		/**
		 * 是否还有数据
		 */
		@ApiField("has_more")
