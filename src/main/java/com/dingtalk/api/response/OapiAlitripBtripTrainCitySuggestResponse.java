...
public class OapiAlitripBtripTrainCitySuggestResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3733462968731766324L;
	...
	public static class CityVo extends TaobaoObject {
		private static final long serialVersionUID = 5784764414666441577L;
		/**
		 * 城市码
		 */
		@ApiField("code")
	...
	public static class SuggestRs extends TaobaoObject {
		private static final long serialVersionUID = 8152267749973993348L;
		/**
		 * 城市列表
		 */
		@ApiListField("cities")
