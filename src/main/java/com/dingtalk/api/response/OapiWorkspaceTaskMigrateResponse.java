...
public class OapiWorkspaceTaskMigrateResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7697912719474368966L;
	...
	public static class TaskSystemProperty extends TaobaoObject {
		private static final long serialVersionUID = 5296984564324783725L;
		/**
		 * APP 跳转链接
		 */
		@ApiField("appUrl")
	...
	public static class TaskExtension extends TaobaoObject {
		private static final long serialVersionUID = 2441824896816995925L;
		/**
		 * 评论数量
		 */
	...
	public static class Task extends TaobaoObject {
		private static final long serialVersionUID = 3172446812177678296L;
		/**
		 * 归属企业id
		 */
