...
public class OapiWikiGroupPublicListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2557612977829999468L;
	...
	public static class OpenGroupVO extends TaobaoObject {
		private static final long serialVersionUID = 3152236419326521796L;
		/**
		 * 知识库的描述
		 */
		@ApiField("desc")
	...
	public static class OpenPageResult extends TaobaoObject {
		private static final long serialVersionUID = 5138845725749468526L;
		/**
		 * 知识库列表
		 */
		@ApiListField("data")
