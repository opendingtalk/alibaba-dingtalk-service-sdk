...
public class OapiRhinoOrderDetailGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1636926939521594222L;
	...
	public static class OpenApiProductOrderDetailDto extends TaobaoObject {
		private static final long serialVersionUID = 6717288813414972959L;
		/**
		 * 主键id
		 */
		@ApiField("id")
	...
	public static class Model extends TaobaoObject {
		private static final long serialVersionUID = 5341715911112183987L;
		/**
		 * 细码列表
		 */
