...
public class OapiWorkbenchShortcutListbypagingResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3622987481216897325L;
	...
	public static class IsvOrgShortcutDTO extends TaobaoObject {
		private static final long serialVersionUID = 6738725339435723828L;
		/**
		 * 业务单号,系统间交互唯一流水号
		 */
		@ApiField("biz_no")
	...
	public static class IsvOrgShortcutListDTO extends TaobaoObject {
		private static final long serialVersionUID = 7851271576958272484L;
		/**
		 * 企业下指定应用已添加快捷方式列表
		 */
