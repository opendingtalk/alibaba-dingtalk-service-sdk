...
public class OapiAttendanceClassGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5836991136179358762L;
	...
	public static class AtTimeVo extends TaobaoObject {
		private static final long serialVersionUID = 7226848297743916822L;
		/**
		 * 是否跨天
		 */
		@ApiField("across")
	...
	public static class AtClassSettingForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 2623765654587339992L;
		/**
		 * classId
		 */
		@ApiField("class_id")
	...
	public static class AtSectionVo extends TaobaoObject {
		private static final long serialVersionUID = 4759312212517565592L;
		/**
		 * 时间段列表
		 */
		@ApiListField("times")
	...
	public static class AtClassForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 7343378612638137746L;
		/**
		 * 考勤组班次配置
		 */
