...
public class OapiRhinoOrderBatchGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1725628433785821428L;
	...
	public static class OpenApiProductOrderDto extends TaobaoObject {
		private static final long serialVersionUID = 1579953345312792492L;
		/**
		 * 实际完成时间
		 */
	...
	public static class OpenApiBatchGetProductOrderResult extends TaobaoObject {
		private static final long serialVersionUID = 3198148314171334676L;
		/**
		 * 列表
		 */
		@ApiListField("list")
